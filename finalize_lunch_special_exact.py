...
backdrop_color = lunch.getpixel((800, 100)) # exact studio background

# Clean out old can using exact backdrop color
...
# 5. Soft realistic contact shadow onto studio floor
...
# 6. Paste Coke can using its own alpha mask
