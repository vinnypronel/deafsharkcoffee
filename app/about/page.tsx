  ...
  return (
    <main className="content-page">
      ...
      <section className="story-grid">
        ...
        <article><span>03</span><h2>A local business</h2><p>Deaf Shark is a veteran-owned neighborhood coffee shop with a distinctive character, an original identity, and a growing community around it.</p></article>
      </section>
      <section className="origin-facts">
        <div><span className="eyebrow">Featured coffee</span><h2>A cup with a place behind it.</h2></div>
        <dl><div><dt>Country</dt><dd>El Salvador</dd></div><div><dt>Farm</dt><dd>Finca Montevideo</dd></div><div><dt>Variety</dt><dd>Red Bourbon</dd></div><div><dt>Process</dt><dd>Washed</dd></div></dl>
      </section>
      <SiteFooter />
    </main>
  );
